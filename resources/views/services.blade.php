...
<head>
    ...
    <!-- Page Title -->
    <title>Web Design - The Design Spark</title>
    <!-- Favicon -->
...
@include('components.navbar')
    ...
    <section class="learn-more-section">
     ...
     <section class="services-section" id="services" style="padding-top: 50px; padding-bottom: 30px;">
        <div class="container">
           <h2 class="wow fadeInDown" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInDown;">Our Services
        </h2>
           <p class="wow fadeInDown" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInDown;">Boost your online presence with our digital agency services! </p>
           <p class="wow fadeInDown" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInDown;">We offer web design, social media management, SEO, and more to help your business succeed. Let's get started!</p>
     ...
     <section class="blog-section" id="blog" style="padding: 30px 0px;">
        <div class="container">
           <div class="row no-gutters">
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 left-text wow fadeInLeftBig bba" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
                 <h2 style="text-align:center;">App Development</h2>
                 <p>Looking for a custom mobile app for your business? Our expert app developers can turn your ideas into reality. From design to launch, we'll guide you through every step of the process to ensure your app stands out in the app store and delivers a great user experience.</p>
                 
                 <a class="btn button btn-rounded btn-light-blue btn-hvr-light-blue" href="javascript:void(0);" style="display:block; margin:0 auto; width:30%;">
                    Read More
              ...
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 wow fadeInRightBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInRightBig;">
                 <img src="classic-business/img/blog-1.jpg" alt="image" style="border-radius: 1rem;">
              </div>
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 right-text order-2 order-lg-1 wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
                 <img src="classic-business/img/blog-2.jpg" alt="image" style="border-radius: 1rem;">
              </div>
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 right-text order-1 order-lg-2 wow fadeInRightBig bba" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInRightBig;">
                 <h2 style="text-align:center;">Web Development
                </h2>
                 <p style="text-align:left;">Looking for a professional website to showcase your business? Our web development team can create a customized website tailored to your unique needs. With our expertise in web design and development.</p>
                 <a class="btn button btn-rounded btn-light-blue btn-hvr-light-blue" href="javascript:void(0);" style="margin-right: 38%; width:30%; margin-top:3px;">
                    Read More
                    <div class="btn-hvr-setting">
                       <ul class="btn-hvr-setting-inner">
                          <li class="btn-hvr-effect"></li>
     ...
     <section class="blog-section" id="blog" style="margin-top:5%;">
        <div class="container">
           <div class="row no-gutters">
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 left-text wow fadeInLeftBig  bba" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
                 <h2 style="text-align:center;">Graphic Design
                </h2>
                 <p>Make a lasting impression with our graphic design services! Our talented designers can help you create stunning visuals that communicate your brand's message effectively. From logos to marketing materials, we'll work with you to develop a cohesive design strategy that sets you apart from the competition and leaves a lasting impression on your target audience.</p>
                 <a class="btn button btn-rounded btn-light-blue btn-hvr-light-blue" href="javascript:void(0); " style="display:block; margin:0 auto; width:30%;">
                    Read More
                    <div class="btn-hvr-setting">
                       <ul class="btn-hvr-setting-inner">
              ...
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 wow fadeInRightBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInRightBig;">
                 <img src="classic-business/img/blog-3.jpg" alt="image" style="border-radius: 1rem;">
              </div>
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 right-text order-2 order-lg-1 wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
                 <img src="classic-business/img/blog-4.jpg" alt="image" style="border-radius: 1rem;">
              </div>
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 right-text order-1 order-lg-2 wow fadeInRightBig bba" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInRightBig;">
                 <h2 style="text-align:center;">UI/UX Design

                </h2>
                 <p style="text-align:left;">Looking to enhance your user's experience and engagement? Our UI/UX design services can help you create an intuitive and visually appealing digital product. Our experienced designers will work with you to understand your users and develop a design strategy that maximizes usability and conversion rates. Whether you're building a website or an app, we'll help you create a product that users will love.</p>
                 <a class="btn button btn-rounded btn-light-blue btn-hvr-light-blue" href="javascript:void(0); " style="margin-right: 38%; width:30%;">
                    Read More
                    <div class="btn-hvr-setting">
                       <ul class="btn-hvr-setting-inner">
                          <li class="btn-hvr-effect"></li>
     ...
     <section class="blog-section" id="blog">
        <div class="container">
           <div class="row no-gutters">
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 left-text wow fadeInLeftBig bba" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
                 <h2 style="text-align:center;">Social Media Services

                </h2>
                 <p>Maximize your online reach with our social media services! Our social media experts can help you develop and implement a comprehensive strategy to increase your online presence, engage with your audience, and drive conversions. From social media management to targeted advertising, we'll help you reach your target audience and achieve your business goals on social media.</p>
                 <a class="btn button btn-rounded btn-light-blue btn-hvr-light-blue" href="javascript:void(0);" style="display:block; margin:0 auto; width:30%;">
                    Read More
                    <div class="btn-hvr-setting">
                       <ul class="btn-hvr-setting-inner">
              ...
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 wow fadeInRightBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInRightBig;">
                 <img src="classic-business/img/blog-5.jpg" alt="image" style="border-radius: 1rem;">
              </div>
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 right-text order-2 order-lg-1 wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
                 <img src="classic-business/img/blog-6.jpg" alt="image" style="border-radius: 1rem;">
              </div>
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 right-text order-1 order-lg-2 wow fadeInRightBig bba" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInRightBig;">
                 <h2 style="text-align:center;">SEO


                </h2>
                 <p style="text-align:left;">Looking to improve your website's visibility on search engines? Our SEO services can help! Our SEO experts can optimize your website's content, structure, and technical elements to improve your search engine rankings and attract more organic traffic. With our comprehensive approach to SEO, we'll help you achieve long-term success and stay ahead of your competition.</p>
                 <a class="btn button btn-rounded btn-light-blue btn-hvr-light-blue" href="javascript:void(0);" style="margin-right: 38%; width:30%;">
                    Read More
                    <div class="btn-hvr-setting">
                       <ul class="btn-hvr-setting-inner">
