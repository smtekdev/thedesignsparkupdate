...
<head>
    ...
    <!-- Page Title -->
    <title>UX/UI Design - The Spark Design</title>
    <!-- Favicon -->
...
.learn-more-section{
    background-image: url(classic-business/img/3da1d6283d.jpg);
}
.image{
    position: absolute;
    top: 11px;
...
<section class="page_content_parent_section" style="padding-top: 0px; margin-top: 0%;">
    ...
    <section class="learn-more-section">
            ...
            <div class="row about-wrap d-flex justify-content-center align-items-center">
                <div class="col-lg-6 col-md-5 col-sm-12 md-mb-5">
                    <div class="image about-bordered">
                        <img src="classic-business/img/5520d800a1.jpg" alt="image">
                    </div>
                ...
                <div class="col-lg-6 col-md-7 col-sm-12">
                    <div class="main-title text-md-left mb-xs-3 md-mb-0 wow fadeIn margin-top-40" data-wow-delay="300ms">
                        ...
                        <h2>UI/UX Design</h2>
                        <p class="mb-4">UI UX designers create the user interface for an app, website, or other interactive media. Their work includes collaborating with product managers and engineers to gather requirements from users before designing ideas that can be communicated using storyboards.
                        </p>
                        <p class="mb-4">
        ...
        <div class="container">
           <div class="row no-gutters">
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 left-text wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
                 <h2>Sketch out your product

                </h2>
                 <p>In the very first step, we need to find out a lot of information about audiences, competitors, and the product we want to create. Also, UX research includes 10 steps separately.</p>
              ...
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 wow fadeInRightBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInRightBig;">
                 <img src="classic-business/img/906510c71f.jpg" alt="image">
              </div>
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 right-text order-2 order-lg-1 wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
                 <img src="classic-business/img/5adb49f15f.jpg" alt="image">
              </div>
     ...
     <section class="blog-section" id="blog">
        <div class="container">
           <div class="row no-gutters">
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 left-text wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
                 <h2>Implement the solution onto a webpage
                </h2>
                 <p>Make sure you portray the entire process of implementing a solution while embedding your products. This enables the visitor to get a new ...</p>
                 <a class="btn button btn-rounded btn-light-blue btn-hvr-light-blue" href="javascript:void(0);">
                    Read Full Story
                    <div class="btn-hvr-setting">
                       <ul class="btn-hvr-setting-inner">
              ...
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 wow fadeInRightBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInRightBig;">
                 <img src="classic-business/img/7091e81020.jpg" alt="image">
              </div>
              <!-- <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 right-text order-2 order-lg-1 wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
