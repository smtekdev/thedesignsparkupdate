...
<head>
    ...
    <!-- Page Title -->
    <title>App Development - The Spark Design</title>
    <!-- Favicon -->
...
.learn-more-section{
    background-image: url(classic-business/img/4f1a04d217.jpg);
}
    </style>
    ...
    <section class="learn-more-section">
            ...
            <div class="row about-wrap d-flex justify-content-center align-items-center">
                <div class="col-lg-6 col-md-5 col-sm-12 md-mb-5">
                    <div class="image about-bordered">
                        <img src="classic-business/img/deb16883bb.jpg" alt="image">
                    </div>
                ...
                <div class="col-lg-6 col-md-7 col-sm-12">
                    <div class="main-title text-md-left mb-xs-3 md-mb-0 wow fadeIn margin-top-40" data-wow-delay="300ms">
                        ...
                        <p class="mb-4">Mobile application development is the process of creating software applications that run on a mobile device, and a typical mobile application utilizes a network connection to work with remote computing resources.
        ...
        <div class="container">
           <div class="row no-gutters">
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 left-text wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
                 ...
                 <p>Hybrid Applications That
                    Works Smoothly With Both Platforms
                    everaging the next and top-level mobile applications in the latest design. We manufacture hybrid applications by using the latest framework such as the Flutter or Reach Native. We have an expert hybrid app development team who deliver the latest and outstanding trends of both platforms android and iOS.. </p>
              ...
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 wow fadeInRightBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInRightBig;">
                 <img src="classic-business/img/19198998.jpg" alt="image">
              </div>
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 right-text order-2 order-lg-1 wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
                 <img src="classic-business/img/972.jpg" alt="image">
              </div>
     ...
     <section class="blog-section" id="blog">
        <div class="container">
           <div class="row no-gutters">
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 left-text wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
                 <h2>Android Application
                </h2>
                 <p>We build an android application with the high quality of the latest programming language, and also provide a user-friendly UI, traditional UX, startup solutions, user interfaces, etc. The Design Spark has an expert team and talented developers that provide you an elegant android application development that helps in the growth of your online business..</p>
                 <a class="btn button btn-rounded btn-light-blue btn-hvr-light-blue" href="javascript:void(0);">
                    Read Full Story
                    <div class="btn-hvr-setting">
                       <ul class="btn-hvr-setting-inner">
              ...
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 wow fadeInRightBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInRightBig;">
                 <img src="classic-business/img/Kerfin7-NEA-2221.jpg" alt="image">
              </div>
              <!-- <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 right-text order-2 order-lg-1 wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
