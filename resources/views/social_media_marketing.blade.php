...
.learn-more-section{
    background-image: url(classic-business/img/ebdb8a1ae1.jpg);
}
    </style>
...
<body data-spy="scroll" data-target=".navbar" data-offset="90">
    ...
    <!-- <section class="banner-sec banner-image" id="banner">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-2 d-flex align-items-center justify-content-center">
                    <div class="banner-area">
                        <h2 class="banner-heading">Hello! I am <span class="d-block"> Interior <span class="text-green">designer.</span> </span></h2>
                        <h4 class="banner-des">Lorem ipsum is simply dummy text of the printing and typesetting and lorem Ipsum has been the industry’s standard dummy.</h4>
                        <a href="#about" class=" btn btn-large-1 scroll btn-rounded btn-trans-white btn-hvr-white">LEARN MORE</a>
                    </div>
                </div>
            </div>
        </div>
...
<h2 class="d-none"></h2>
        ...
        <nav class="navbar navbar-expand-lg nav-bottom-line center-brand static-nav">
            <div class="container">
                <a class="navbar-brand" href="#banner-main">
                    <img src="agency-studio/img/logo-dark.png" alt="logo" class="logo-default">
                    <img src="agency-studio/img1/White-The-Design-Spark.png" alt="logo" class="logo-scrolled">
                </a>
                ...
                <div class="collapse navbar-collapse" id="xenav">
                    <ul class="navbar-nav" id="container">
                        <li class="nav-item">
                            <a class="nav-link pagescroll" href="index-agency-studio.html">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link pagescroll" href="about-us.html">About</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link pagescroll" href="portfolio.html">Portfolio</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link pagescroll" href="services.html">Website Design</a>
                        </li>
                    </ul>
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link pagescroll" href="app-development.html">App Development</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link pagescroll" href="ui-uxdesign.html">UI/UX Design</a>
                        </li>
                        <!-- <li class="nav-item">
                            <a class="nav-link pagescroll" href="seo.html">SEO</a>
                        </li> -->
                        <li class="nav-item">
                            <a class="nav-link pagescroll" href="contact.html">Contact Us</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 d-flex align-items-center justify-content-center">
                        <div class="banner-area">
                            <h2 class="banner-heading"><span class="d-block">About Us<span class="text-green"></span> </span></h2> -->
                            <!-- <h4 class="banner-des">Lorem ipsum is simply dummy text of the printing and typesetting and lorem Ipsum has been the industry’s standard dummy.</h4> -->
                            <!-- <a href="#about" class=" btn btn-large-1 scroll btn-rounded btn-trans-white btn-hvr-white">LEARN MORE</a> -->
                        <!-- </div>
                    </div>
            ...
            <div class="inner-wrapper">
                ...
                <nav class="side-nav w-100">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link pagescroll" href="#skill_section">About</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link pagescroll" href="#work">Our Work</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link pagescroll" href="#team">Team</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link pagescroll" href="#pricing_table">Pricing</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link pagescroll" href="#reviews">Reviews</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link pagescroll" href="#blog">Blog</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link pagescroll" href="#contactus">Contact US</a>
                        </li>
                    </ul>
                </nav>

                <div class="side-footer w-100">
                    <p class="whitecolor">&copy; 2023 Studio. Made With Love by themesindustry</p>
                </div>
            </div>
        </div>
    ...
    <section class="learn-more-section">
        <div class="container">
           <div class="text-area wow fadeInDown" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInDown;">
              <!-- <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p> -->
              <h2></h2>
              <a class="btn button btn-rounded trans-btn btn-hvr-white wow fadeInUp" data-wow-delay="300ms" href="javascript:void(0);" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInUp;">
     ...
     <!-- <section class="services-section" id="services">
        <div class="container">
           <h2 class="wow fadeInDown" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInDown;">Our Exclusive Services</h2>
           <p class="wow fadeInDown" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInDown;">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
           <div class="row no-gutters ">
             
              <div class="col-lg-4 col-md-4 col-sm-12 flip-boxes wow fadeInLeft" data-wow-delay="400ms" style="visibility: visible; animation-delay: 400ms; animation-name: fadeInLeft;">
                 <div class="flip-box">
              ...
              <div class="col-lg-4 col-md-4 col-sm-12 flip-boxes wow fadeIn" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeIn;">
                 <div class="flip-box">
              ...
              <div class="col-lg-4 col-md-4 col-sm-12 flip-boxes wow fadeInRight" data-wow-delay="400ms" style="visibility: visible; animation-delay: 400ms; animation-name: fadeInRight;">
                 <div class="flip-box">
                    <div class="flip-box-inner">
                       <div class="flip-box-front">
            ...
            <div class="row about-wrap d-flex justify-content-center align-items-center">
                <div class="col-lg-6 col-md-5 col-sm-12 md-mb-5">
                    <div class="image about-bordered">
                        <img src="classic-business/img/9ea012d433.jpg" alt="image">
                    </div>
                ...
                <div class="col-lg-6 col-md-7 col-sm-12">
                    <div class="main-title text-md-left mb-xs-3 md-mb-0 wow fadeIn margin-top-40" data-wow-delay="300ms">
                        ...
                        <p class="mb-4">Open the door of much traffic, piles of sales, and tons of happy clients by doing a smartly social media marketing strategy. It is not just a name for sharing pictures and interact with buddies. People earn a vast amount of traffic and bucks by using social media for business and placing social media ads. Also, there are several types of social media marketing for the use of their social media promotion.
                        </p>
                        <p class="mb-4">
     ...
     <section class="services-section" id="services">
        <div class="container">
           <!-- <h2 class="wow fadeInDown" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInDown;">Our 6 Step Process
        </h2>
           <p class="wow fadeInDown" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInDown;">Our tried-and-tested six-step process guarantees</p>
           <p class="wow fadeInDown" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInDown;">that your brand ends up well-optimized, industry-specific, and glitch free.</p> -->
     ...
     <section class="blog-section" id="blog">
        <div class="container">
           <div class="row no-gutters">
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 left-text wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
                 <h2>Interact Users

                </h2>
                 <p>Interact Users With Impressive
                    Facebook Marketing Without a strategy, nothing is done perfectly. In our Facebook marketing services, we never forward our step ahead until making an independent strategy. In Facebook advertising management, first, our experts learn more about your business through a brief questionnaire, kick-off call, and independent research. This Facebook advertising service tactic assists in interacting with users..</p>
              ...
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 wow fadeInRightBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInRightBig;">
                 <img src="classic-business/img/9552c60e5f.jpg" alt="image">
              </div>
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 right-text order-2 order-lg-1 wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
                 <img src="classic-business/img/7b66258668.jpg" alt="image">
              </div>
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 right-text order-1 order-lg-2 wow fadeInRightBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInRightBig;">
                 <h2>
                    Lead More Items Through

                </h2>
                 <p>Lead More Items Through
                    Youtube Marketing
                    Online reputation management provides an offer to people to get more knowledge about your brand. We at Artx Pro help many of our international or national brands to gain more audiences. We are highly capable and passionate about driving the impeccable growth of your business through our YouTube..</p>
                 <a class="btn button btn-rounded btn-light-blue btn-hvr-light-blue" href="javascript:void(0);">
                    Read Full Story
                    <div class="btn-hvr-setting">
                       <ul class="btn-hvr-setting-inner">
     ...
     <section class="blog-section" id="blog">
        <div class="container">
           <div class="row no-gutters">
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 left-text wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
                 <h2>LinkedIn Marketing 
                </h2>
                 <p>LinkedIn Marketing is Way
                    To Enhance Brand Visibility & Credibility
                    Get more clients with high interaction through LinkedIn connections and high-quality content. The best LinkedIn advertising agency is here to provide you awareness to people who follow your LinkedIn page, which is helpful in increase your brand visibility and brand awareness and accelerate your business in inbound marketing..</p>
                 <a class="btn button btn-rounded btn-light-blue btn-hvr-light-blue" href="javascript:void(0);">
                    Read Full Story
                    <div class="btn-hvr-setting">
                       <ul class="btn-hvr-setting-inner">
     ...
     <!-- <section class="blog-section" id="blog">
        <div class="container">
           <div class="row no-gutters">
              ...
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 wow fadeInRightBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInRightBig;">
                 <img src="classic-business/img/blog-5.jpg" alt="image">
              </div>
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 right-text order-2 order-lg-1 wow fadeInLeftBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInLeftBig;">
                 <img src="classic-business/img/blog-6.jpg" alt="image">
              </div>
              <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 right-text order-1 order-lg-2 wow fadeInRightBig" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInRightBig;">
                 <h2>Optimization + Launch


                </h2>
                 <p>You may have a very well designed brand but it will serve no real purpose if it is unable to attract the right kind of traffic. To achieve this, it has to show up on the top spots in online searches conducted by prospective customers. We optimize your website for search engines and build your online presence by ensuring that your site is on top of search engine result pages for more qualified traffic. </p>
                 <a class="btn button btn-rounded btn-light-blue btn-hvr-light-blue" href="javascript:void(0);">
                    Read Full Story
                    <div class="btn-hvr-setting">
                       <ul class="btn-hvr-setting-inner">
...
<h2 class="d-none">jd</h2>
                ...
                <div class="col-md-6 col-12">
                    ...
                    <div class="side_section_text big_padding">
                        ...
                        <p class="default_text_light default_text open_sans">
                            ...
                            We help brands that are looking for good hands to guide them through the process of growth. We work with both established and upcoming entrepreneurs and it’s our job or pleasure to make sure that their brands succeed. We’re a multidisciplinary agency, meaning we have experts in all aspect of marketing including content generation, social media, branding, and advertising.
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="pricing_table_column wow slideInLeft">
                            ...
                            <div class="pricing_button">
                                ...
                                <a href="#." class="btn btn-blue-black btn-rounded btn-large open_sans bg_before_navy">Buy Now</a>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="pricing_table_column blue_price wow fadeInUpBig">
                            ...
                            <div class="pricing_button">
                                ...
                                <a href="#." class="btn btn-white-blue btn-rounded btn-large open_sans bg_before_pink navy_blue">Buy Now</a>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            ...
                            <p class="customer_feedback_text white_color open_sans default_text font_200">
                                ...
                                Being a small business it’s important for us that we keep control of our marketing spend and get maximum return on investment. The Spark Design understand this need perfectly and have put together a successful social media and AdWords campaign that has exceeded my expectation and met the brief perfectly. Media Waypoint continue to manage my online marketing and I don’t hesitate in recommending them.

                            </p>

                            <p class="customer_feedback_name white_color open_sans default_small_heading font_600">Andrew Carter - Client</p>
                        ...
                        <div class="swiper-slide">
                            ...
                            <p class="customer_feedback_text white_color open_sans default_text font_200">
                               ...
                               I have used The design spark for many years now and since they took over my online marketing, my business has gone from strength to strength. They got to grips with my PPC campaigns, saving me money while also improving performance and I am now finally appearing on page one of Google as a result of their SEO efforts.

                            </p>

                            <p class="customer_feedback_name white_color open_sans default_small_heading font_600">Mike Howell - Client</p>
                        ...
                        <div class="swiper-slide">
                            ...
                            <p class="customer_feedback_text white_color open_sans default_text font_200">
                                ...
                                I've been using The Design Spark for just over one year and I'm very happy with the results which have far exceeded my expectation and surpassed anything that has been done before.

                            </p>

                            <p class="customer_feedback_name white_color open_sans default_small_heading font_600">Mark Morris - Client</p>
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="blog_slide wow slideInLeft">
                            ...
                            <div class="blog_img">
                                ...
                                <img src="agency-studio/img/blog_post_1.jpg" alt="blog_img">
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="blog_slide wow fadeInDownBig">
                            ...
                            <div class="blog_img">
                                ...
                                <img src="agency-studio/img/blog_post_2.jpg" alt="blog_img">
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="blog_slide wow slideInRight">
                            ...
                            <div class="blog_img">
                                ...
                                <img src="agency-studio/img/blog_post_3.jpg" alt="blog_img">
    ...
    <!-- Footer Section -->
    <footer class="footer_section big_padding bg_navy" style="margin-bottom: -8%;">
        ...
        <div class="container">
            ...
            <div class="footer_detail">
                ...
                <ul class="footer_links text-center">
                    ...
                    <li>
                        ...
                        <a class="anchor_style_default g_plus wow zoomInDown" href="#.">
                            ...
                            <i class="text-center fab fa-google-plus "></i>
                ...
                <p class="text-center default_text open_sans white_color">&copy; 2023 The Spark Design,  All rights reserved. </p>
...
<!-- JavaScript -->
<script src="vendor/js/bundle.min-1.js"></script>

<!-- Plugin Js -->
<script src="vendor/js/owl.carousel.min-1.js"></script>
<script src="vendor/js/wow.js"></script>
<script src="vendor/js/jquery.cubeportfolio.min-1.js"></script>
<script src="vendor/js/jquery.appear-1.js"></script>
<script src="vendor/js/isotope.pkgd.min.js"></script>
<script src="vendor/js/jquery.fancybox.min-1.js"></script>
<script src="vendor/js/parallaxie.min-1.js"></script>
<!-- REVOLUTION JS FILES -->
...
<!-- contact form js -->
<script src="vendor/js/contact_us-1.js"></script>

<script src="agency-studio/js/swiper.js"></script>
<script src="agency-studio/js/script.js"></script>

<script src="js1/jquery.revslider-focus-parallax.js"></script>
<script src="js1/match-height.js"></script>

<script src="js1/script.js"></script>
<script src="creative-parallax/js/script.js"></script>
...
<script src="creative-studio/js/owl.carousel.js"></script>
<link href="interior-designer/css/line-awesome.min.css" rel="stylesheet">
<!-- Style Sheet -->
<link href="interior-designer/css/style.css" rel="stylesheet">
<link href="interior-designer/css/custom.css" rel="stylesheet">
